...
//
// ¡ACTUALIZADO! Esta lógica es una copia de 'referencia.js'
// para usar el sistema de fondo verde (chroma key) y post-procesado.
// =================================================================

// ¡Ruta de importación corregida para estar DENTRO de /editorcreador!
        ...
        img.onload = () => {
            ...
            for (let i = 0; i < data.length; i += 4) {
                ...
                if (distance < hardTolerance) {
                    ...
                    // --- CORRECCIÓN ---
                    // La línea original creaba píxeles semi-transparentes.
                    // Esto evita crear píxeles semi-transparentes que el
                    // alphaTest: 0.1 del motor 3D (engine_3d.js) descartaría.
                    // El resultado es un borde más duro, pero visible.
                }
            }
